	...
	public class SnapGame
	{
		...
		private static void DrawGame(Snap myGame)
		{
			...
			if (top != null)
			{
				...
				SwinGame.DrawText ("Player 1 score: " + myGame.Score(0), Color.White,"GameFont", 0, 100);
				SwinGame.DrawText ("Player 2 score: " + myGame.Score(1), Color.White, "GameFont", 650, 100);
				SwinGame.DrawCell (SwinGame.BitmapNamed ("Cards"), top.CardIndex, 521, 153);
			}
			else
			{
				SwinGame.DrawText ("No card played yet...", Color.White, "GameFont", 0, 0);
			}
